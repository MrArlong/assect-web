...
export const asyncRouterMap = [
  // 资产
  {
    path: '/asset',
    component: Layout,
    redirect: '/asset/assetFloor',
    name: 'asset',
    meta: { title: '资产', icon: 'assetFloor' },
    children: [{
      path: 'assetFloor',
      name: 'assetFloor',
      component: () => import('@/views/asset/assetFloor/index'),
      meta: { title: '资产配置', icon: 'asset-floor' }
    },
    {
      path: 'addBrand',
      name: 'addBrand',
    ...
    },
    {
      ...
      meta: { title: '房间配置', icon: 'room-list' }
    },
    {
      path: 'addRoom',
      name: 'addRoom',
    ...
    },
    {
      path: 'orderFormAdd',
      name: 'orderFormAdd',
      component: () => import('@/views/asset/order/add'),
      meta: { title: '添加订单', icon: 'order-add' },
      hidden: true
    }, {
      path: 'updateOrder',
      name: 'updateOrder',
      component: () => import('@/views/asset/order/update'),
      meta: { title: '编辑订单', icon: 'order-add' },
      hidden: true
    },
    {
